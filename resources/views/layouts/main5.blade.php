...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/cssPesan.css') }}">
...
<div id="preloader"></div>
  <header>
    <a href="/"><img class="logo" src="{{asset('images/logo1.png') }}" alt="logo" widht = "70" height = "70"></a>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="useful-link">
                        ...
                        <p>><a href="#payment">Pembayaran</a></p><br>
                        <a href="https://www.facebook.com/pages/Brew%20Brother%20Coffee%20&%20Roastry/355704245329646/"><img src="{{asset('images/iconFb.png') }}" width="40px" alt="fb-icon"></a>            
                        <a href="https://www.instagram.com/brewbrothercoffee/"><img src="{{asset('images/iconIg.png') }}" width="50px" alt="ig-icon"></a>
                    </div>
                </div>
